...
<header>
    ...
    <h1>Attendance</h1>
    <br>
    <a class="btn btn-primary" href="AddNewAttendance.php" role="button">Add New Attendance</a>
    <table class="table">
        ...
        <?php
            ...
            while ($row = $result -> fetch_assoc()) {
                echo "<tr>
                    ...
                    <td>" . $row["PupilID"] . "</td>
                    <td>
                        <button onclick=\"location.href='EditAttendance.php?action=EditAttendance&AttendanceID={$row['AttendanceID']}'\">Edit</button>
                        <button onclick=\"location.href='DeleteAttendance.php?action=DeleteAttendance&AttendanceID={$row['AttendanceID']}'\">Delete</button>
                    </td>
                </tr>";
            }
            ?>
