...
<header>
    ...
    <h1>Subject</h1>
    <br>
    <a class="btn btn-primary" href="AddNewSubject.php" role="button">Add New Subject</a>
    <table class="table">
        <thead>
            <tr>
                <th>SubjectID</th>
                <th>Subject_Name</th>
                <th>Subject_Timetable</th>
                <th>Subject_StartDate</th>
                <th>Subject_EndDate</th>
                <th>Functions</th>
            </tr>
        </thead>
        ...
        <?php
            ...
            while ($row = $result -> fetch_assoc()) {
                echo "<tr>
                    ...
                    <td>" . $row["Subject_Timetable"] . "</td>
                    <td>" . $row["Subject_StartDate"] . "</td>
                    <td>" . $row["Subject_EndDate"] . "</td>
                    <td>
                        <button onclick=\"location.href='EditSubject.php?action=EditSubject&SubjectID={$row['SubjectID']}'\">Edit</button>
                        <button onclick=\"location.href='DeleteSubject.php?action=DeleteSubject&SubjectID={$row['SubjectID']}'\">Delete</button>
                    </td>
                </tr>";
            }
            ?>
